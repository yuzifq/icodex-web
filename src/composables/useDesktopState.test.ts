...
describe('filterGroupsByWorkspaceRoots', () => {
    ...
    const groups: UiProjectGroup[] = [
      {
        ...
        threads: [thread('testchat-chat', '/Users/tester/temp/TestChat')],
      },
    ]
    const rootsState: WorkspaceRootsState = {
      order: ['/Users/tester/Documents/New project 2/TestChat', '/Users/tester/temp/TestChat'],
      labels: {},
      active: ['/Users/tester/Documents/New project 2/TestChat', '/Users/tester/temp/TestChat'],
      projectOrder: ['/Users/tester/Documents/New project 2/TestChat', '/Users/tester/temp/TestChat'],
    }

    expect(filterGroupsByWorkspaceRoots(groups, rootsState).map((group) => [group.projectName, group.threads.length])).toEqual([
      ['/Users/tester/Documents/New project 2/TestChat', 0],
      ['/Users/tester/temp/TestChat', 1],
    ])
  })
    ...
    const groups: UiProjectGroup[] = [
      {
        ...
        threads: [
          thread('main-chat', '/Users/tester/Git-projects/codex-web-local'),
          thread('worktree-chat', '/Users/tester/.codex/worktrees/53e7/codex-web-local', { hasWorktree: true }),
        ],
      },
    ]
    const rootsState: WorkspaceRootsState = {
      order: ['/Users/tester/Git-projects/codex-web-local'],
      labels: {},
      active: ['/Users/tester/Git-projects/codex-web-local'],
      projectOrder: ['/Users/tester/Git-projects/codex-web-local'],
    }
  ...
  it('keeps unregistered managed worktrees under the main root when another managed worktree root is registered', () => {
    const groups: UiProjectGroup[] = [
      {
        ...
        threads: [
          thread('main-chat', '/Users/tester/Git-projects/codex-web-local'),
          thread('registered-worktree-chat', '/Users/tester/.codex/worktrees/a77f/codex-web-local', { hasWorktree: true }),
          thread('unregistered-worktree-chat', '/Users/tester/.codex/worktrees/53e7/codex-web-local', { hasWorktree: true }),
        ],
      },
    ]
    const rootsState: WorkspaceRootsState = {
      order: [
        '/Users/tester/Git-projects/codex-web-local',
        '/Users/tester/.codex/worktrees/a77f/codex-web-local',
      ],
      labels: {
        '/Users/tester/.codex/worktrees/a77f/codex-web-local': 'codex-web-local2',
      },
      active: ['/Users/tester/Git-projects/codex-web-local'],
      projectOrder: ['/Users/tester/Git-projects/codex-web-local'],
    }
    ...
    expect(filterGroupsByWorkspaceRoots(groups, rootsState).map((group) => [group.projectName, group.threads.map((row) => row.id)])).toEqual([
      ['/Users/tester/Git-projects/codex-web-local', ['main-chat', 'unregistered-worktree-chat']],
      ['/Users/tester/.codex/worktrees/a77f/codex-web-local', ['registered-worktree-chat']],
    ])
  })
  ...
  it('does not group unrelated git worktrees under a same-leaf workspace root project', () => {
    ...
    expect(filterGroupsByWorkspaceRoots(groups, rootsState).map((group) => [group.projectName, group.threads.map((row) => row.id)])).toEqual([
      ['/Users/tester/Git-projects/codex-web-local', ['main-chat']],
    ])
  })
})
