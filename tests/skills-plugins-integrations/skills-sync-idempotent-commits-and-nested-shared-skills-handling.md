...
3. `/Users/tester/.codex/skills/shared_skills` exists as a nested Git repository
...
4. Modify a file inside `/Users/tester/.codex/skills/shared_skills` without committing it inside that nested repository.
5. Click `Push` or `Startup Sync` again.
6. Confirm the sync does not show `Command failed (git commit -m Sync installed skills folder and manifest)` for the parent `/Users/tester/.codex/skills` repository.
...
#### Rollback/Cleanup
- Revert or commit the intentional test edit inside `/Users/tester/.codex/skills/shared_skills`.
