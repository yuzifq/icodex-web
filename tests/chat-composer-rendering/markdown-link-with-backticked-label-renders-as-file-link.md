...
- File exists at `/Users/tester/temp/TestChat/qwe.txt`.

#### Steps
1. Send this exact message:
   [`/Users/tester/temp/TestChat/qwe.txt`](/Users/tester/temp/TestChat/qwe.txt)
2. In the rendered message, confirm it appears as one clickable file link.
3. Verify the visible link text is `/Users/tester/temp/TestChat/qwe.txt` (without backticks).
...
- Clicking opens `/codex-local-browse/Users/tester/temp/TestChat/qwe.txt`.
