...
Provider selectors, model menus, OpenRouter, OpenCode Zen, custom endpoints, Responses/Completions format, and model refresh behavior.
...
| [OpenRouter API format toggle (Responses vs Completions)](openrouter-api-format-toggle-responses-vs-completions.md) |
